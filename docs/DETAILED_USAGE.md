...
Launch the configuration by running the `init` command:

`./node_modules/.bin/ellie init`
...
You can extend your configuration files and override the values. This is specially useful when you want to create different config file for various test sets or even test environments.
...
`./node_modules/.bin/ellie ellie.component.conf.js`
